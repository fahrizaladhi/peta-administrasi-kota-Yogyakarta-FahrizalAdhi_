...
map.getView().fit([12279734.185364, -875770.009377, 12295063.925975, -867064.047583], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA ADMINISTRASI KOTA YOGYAKARTA</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (228 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta Administrasi Kota Yogyakarta menampilkan batas wilayah dan kecamatan sebagai informasi spasial untuk mendukung perencanaan, pengelolaan wilayah, dan pengambilan keputusan.<br />NAMA : FAHRIZAL ADHI PRASTYAWAN<br />NIT    : 2502010006';
            }
